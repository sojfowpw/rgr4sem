    ...
    return (
        <div>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "20px", margin: "20px 0"}}>
                <button className="button_admin_people" onClick={() => navigate('/people')}>Данные о работниках</button>
                <button className="button_admin_devices" onClick={() => navigate('/devices/admin')}>Данные об устройствах</button>
            </div>
            <button className="button_admin_out" onClick={handleLogout}>Выйти</button>
